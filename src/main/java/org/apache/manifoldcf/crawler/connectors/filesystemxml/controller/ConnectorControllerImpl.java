...
public class ConnectorControllerImpl implements ConnectorController {
      ...
      throws ManifoldCFException
  {
    ...
    ds.clearChildren();
    SpecificationNode node = new SpecificationNode("fileSelector");
    node.setValue(fileSelectorValue);
    ds.addChild(0,node);
      ...
      throws ManifoldCFException, IOException
  {
    ...
    SpecificationNode sn = ds.getChild(0);
    String fileSelectorValue = sn.getValue();
